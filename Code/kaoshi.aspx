<%@ Page Language="C#" AutoEventWireup="true" CodeFile="kaoshi.aspx.cs" Inherits="kaoshi" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head>
    <title>模拟测试 - 信息安全竞赛练习系统</title>
    <meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <meta content="images/logo.png"  itemprop="image" />
    <link rel="shortcut icon" href="images/logo.png"  type="image/x-icon" />
    <link rel="Stylesheet" type="text/css" href="css/kaoshi.css" />
    <link rel="Stylesheet" type="text/css" href="css/loading.css" />
    <script charset="utf-8" type="text/javascript" src="js/jquery-1.7.2.js"></script>
    <script charset="utf-8" type="text/javascript" src="js/ceshi.js"></script>
</head>
<body>
    <div class="wrapper">
        <form id="kaoshi" action="jiaojuan.aspx" method="post">
        <input type="hidden" value="<%#kaoshiid%>" name="kaoshiId" />
            ...
            <div class="broder">
                ...
                <div class="select">
                    ...
                    <div class="selectbtn">
                        ...
                        <input class="btnwidth" type="button" onclick="jiaojuan()" value="交卷" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="jishi">
        <p>剩余时间</p>
        <h1><span id="jishimin"></span>:<span id="jishisec"></span></h1>
    </div>
    <div id="mainloading" style="display:none;">
        <div id="load">
            <div id="circular">
                <div id="circular_1" class="circular">
                </div>
                <div id="circular_2" class="circular">
                </div>
                <div id="circular_3" class="circular">
                </div>
                <div id="circular_4" class="circular">
                </div>
                <div id="circular_5" class="circular">
                </div>
                <div id="circular_6" class="circular">
                </div>
                <div id="circular_7" class="circular">
                </div>
                <div id="circular_8" class="circular">
                </div>
                <div id="circular_9" class="circular">
                </div>
                <div id="circular_10" class="circular">
                </div>
            </div>
            <div id="circularwords">交卷中</div>
        </div>
    </div>
</body>
</html>
